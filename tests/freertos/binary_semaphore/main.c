 ...
 *
 * This task checks if button is pressed and signals the event with binary semaphore.
 * 
 */
    ...
    for ( ;; )
    {
        ...
        if( previousButtonState != currentButtonState){
            ...
            if(currentButtonState == 0){
                /* If button is still pressed signalise the event */
 ...
 *
 * This task toggles LED on each button press event.
 * 
 */
