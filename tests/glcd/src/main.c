...
static void test2( void )
{
    ...
    ellipse e2[10] = {
        { {{64, 32}, {80, 32}}, 20.0f, 2, true },
        { {{64, 32}, {80, 32}}, 25.0f, 2, false },
        { {{64, 32}, {80, 32}}, 30.0f, 2, true },
        { {{64, 32}, {80, 32}}, 35.0f, 2, false },
        { {{64, 32}, {80, 32}}, 40.0f, 2, true },
        { {{64, 32}, {80, 32}}, 45.0f, 2, false },
        { {{64, 32}, {80, 32}}, 50.0f, 2, true },
        { {{64, 32}, {80, 32}}, 55.0f, 2, false },
        { {{64, 32}, {80, 32}}, 60.0f, 2, true },
        { {{64, 32}, {80, 32}}, 65.0f, 2, false }
    };
    for (uint8_t i = 0; i < 10; i++) {
