...
Test is considered successful if the board responds to ARP requests and ICMP pings, and serves the HTML page when accessing `http://172.20.22.200` from a browser on the same network.
