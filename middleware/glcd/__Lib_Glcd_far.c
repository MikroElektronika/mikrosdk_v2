...
// Externs
extern far sfr unsigned long GLCD_DataPort_Input;
extern far sfr unsigned long GLCD_DataPort_Output;

extern far sfr sbit GLCD_CS1,
                GLCD_CS2,
                GLCD_RS,
                GLCD_RW,
                GLCD_RST,
...
// Dodatak da bi moglo da radi sa novijom verzijom vitaelko displejima  MŽ 20090630
  GLCD_RST = 0;
...
// turn ON GLCD and set START line             // Ovo nam ne treba vise
  ...
  Delay_1us();     //                            // reseno sa najnovijim pristupom MŽ 20090630
  GLCD_RST := 1;*/ //                            //
  ...
  GLCD_RST = 1;  // Dodatak da bi moglo da radi sa novijom verzijom vitaelko
                 // displejima  MŽ 20090630
  
  Delay_1us();   // Dodat dilej jer je shvalerko(dsPIC) brz pa na nekim displejima
                 // potpuno odsece levu polovinu displeja        MŽ 20081118
