...
function(usb_get_device_lib_files libSourceList libHeaderList)
    ...
    elseif(${MCU_NAME} MATCHES "^R7.+$")
        list(APPEND listLocalSources "${CMAKE_CURRENT_SOURCE_DIR}/lib/portable/renesas/rusb2/dcd_rusb2.c")
        list(APPEND listLocalSources "${CMAKE_CURRENT_SOURCE_DIR}/lib/portable/renesas/rusb2/rusb2_common.c")
    else()
...
macro(usb_generate_isr_source fileDestination fileList)
    ...
    elseif(${MCU_NAME} MATCHES "^R7.+$")
        set(ISR_MACRO "usbfs_interrupt_handler")
    endif()
...
function(usb_set_init_sequence file_path)
    ...
    if(${MCU_NAME} MATCHES "^STM32.+")
        ...
        elseif(${MCU_NAME} MATCHES "^STM32(L4[1-9A][2-9]).+")
    ...
    elseif(${MCU_NAME} MATCHES "^R7.+$")
        set(${file_path} "arm/renesas/implementation_1" PARENT_SCOPE)
    else()
