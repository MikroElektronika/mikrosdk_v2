...
function(usb_get_device_lib_files libSourceList libHeaderList)
    ...
    list(APPEND listLocalHeaders "${CMAKE_CURRENT_SOURCE_DIR}/lib/host/usbh_classdriver.h")
    ## Device headers
    ...
    elseif(${MCU_NAME} MATCHES "^STM32.+$")
        if(${MCU_NAME} MATCHES "^STM32(F04.+|F07[028].+|F10[23].+|F30[23].[BC]|F30[23].[68DE]2?|F373.+|L0.[23].+|L1.+|L4.[23].+)$")
        ...
        elseif(${MCU_NAME} MATCHES "^STM32H7.+")
            list(APPEND listLocalSources "${CMAKE_CURRENT_SOURCE_DIR}/lib/portable/st/synopsys/dcd_synopsys.c")
        elseif(${MCU_NAME} MATCHES "^STM32L4.[56].+")
    ...
    elseif(${MCU_NAME} MATCHES "^GD32VF103.+$")
        ## According to <https://github.com/hathach/tinyusb/issues/1022>,
        ## new dcd_synopsys driver doesn't work with GD32VF103x.
        # list(APPEND listLocalSources "${CMAKE_CURRENT_SOURCE_DIR}/lib/portable/st/synopsys/dcd_synopsys.c")
        ## Take dcd_dwc2 driver.
        list(APPEND listLocalSources "${CMAKE_CURRENT_SOURCE_DIR}/lib/portable/synopsys/dwc2/dcd_dwc2.c")
...
function(usb_get_header_list header_list selector)
    ...
    if(${selector} STREQUAL "HOST")
        ...
        list(APPEND listLocal "${CMAKE_CURRENT_SOURCE_DIR}/lib/host/usbh_classdriver.h")
...
macro(usb_generate_config fileDestination fileList)
    ...
    if (${extra_count} GREATER 0)
        ...
        # in dcd_synopsys.c for STM32F1
        # in dcd_stm32_fsdev_pvt_st.h for STM32F3
...
macro(usb_generate_isr_source fileDestination fileList)
    ...
    if(${MCU_NAME} MATCHES "^STM32.+")
        ...
        elseif(${MCU_NAME} MATCHES "^STM32(F37|L1).+")
