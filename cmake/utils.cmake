...
function(get_selected_logger log_type)
    ...
    if (DEFINED LOG_INTERFACE)
        if(${LOG_INTERFACE} STREQUAL "UART_LOGGER_INTERFACE")
            set(${log_type} "UART_LOGGER_INTERFACE" PARENT_SCOPE)
        elseif(${LOG_INTERFACE} STREQUAL "STDOUT_LOGGER_INTERFACE")
            set(${log_type} "STDOUT_LOGGER_INTERFACE" PARENT_SCOPE)
        endif()
    else()
        set(${log_type} "UART_LOGGER_INTERFACE" PARENT_SCOPE)
    endif()
